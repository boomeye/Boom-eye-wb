        ...
        <div className="hidden xl:flex mx-auto flex-wrap p-5 flex-col xl:flex-row items-center justify-between">
          ...
          <div className="flex flex-col flex-none items-start">
            <div className="flex items-center mb-2">
              ...
              <p className="font-archivo text-xs font-normal leading-[150%] tracking-[0%] align-middle">
                Awesome Plaza, Suite A28 (Ground Floor) <br />
                Opp. Chicken Republic (Off Apo Novare Mall) <br />
