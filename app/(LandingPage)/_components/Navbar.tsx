...
const Navbar = () => {
  ...
  const linkClasses = (href: string) =>
    `hover:text-[#69A6C9] font-archivo text-base leading-[150%] tracking-[0%] text-center align-middle ${pathname === href ? 'text-[#69A6C9] font-semibold' : 'text-[#454545] font-medium'
    }`;

  const mobileLinkClasses = (href: string) =>
    `block px-4 py-2 text-base font-archivo hover:bg-gray-100 ${pathname === href ? 'text-[#69A6C9] font-semibold' : 'text-gray-700 font-medium'
    }`;

  const mobileDropdownLinkClasses = (href: string) =>
    `block px-4 py-2 text-base font-archivo hover:bg-white/10 ${pathname === href ? 'text-[#69A6C9] font-semibold' : 'text-white font-medium'
    }`;
    ...
    <nav className="sticky top-0 z-50 max-w-[120rem] mx-auto">
      ...
      <div className="hidden xl:flex xl:items-center xl:justify-start xl:space-x-[120px] mx-auto px-5 bg-white text-gray-800 shadow-sm h-[44px]">
        ...
        <div className="flex items-center space-x-[32px]">
          ...
          >
            <button className={`flex items-center font-archivo text-[#F4931C] text-base leading-[150%] tracking-[0%] text-center align-middle ${pathname.startsWith('/shop') ? 'font-semibold' : 'font-medium'
              }`}>
      ...
      <div className="xl:hidden flex h-[56px] w-full">
        ...
        <Link href="https://care.ecmsapx.com/appointment/28X74K" className="flex-1 bg-[#0A0A23] flex items-center justify-end pr-[32px] pl-6">
      ...
      <div className={`fixed top-0 right-0 h-full w-[300px] bg-white transform transition-transform duration-300 ease-in-out z-50 xl:hidden ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
        }`}>
