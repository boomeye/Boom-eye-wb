      ...
      {showDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
            ...
            <h3 className={`text-lg font-semibold text-center mb-2 font-archivo ${isSuccess ? 'text-green-800' : 'text-red-800'
              }`}>
            ...
            <div className="flex justify-center">
              <button
                onClick={closeDialog}
                className={`px-6 py-2 rounded-lg font-medium transition-colors font-archivo ${isSuccess
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#6092A7] outline-none transition-all font-archivo ${errors.name ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
                {errors.name && (
              ...
              <div>
                <textarea
                  ...
                  rows={6}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#6092A7] outline-none transition-all resize-none font-archivo ${errors.review ? 'border-red-500' : 'border-gray-300'
                    }`}
                ></textarea>
                {errors.review && (
              ...
              <div className="flex items-start">
                <input
                  ...
                  className={`h-4 w-4 text-[#6092A7] border rounded focus:ring-[#6092A7] ${errors.consent ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
